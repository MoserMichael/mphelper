...
- Adds an object with shared memory counters, that keeps track of the number of completed tasks, vs number of submitted tasks; the mean execution time of each task, as well as the maximum and minimum of the execution times of each task, the number of currently active worker processors.
